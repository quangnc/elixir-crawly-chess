defmodule LogonData do
  ...
  def decode(bin) do
    ...
    <<_::binary-size(12), rest::binary>> = rest  #remove 12 bytes 83::size(16) 0::size(16) 0::size(32) 0::size(16) 0::size(16)
    {name, rest} = BinUtils.read_string(rest)
    {pass, rest} = BinUtils.read_string(rest)
    <<bytes_random::binary-size(16), rest::binary>> = rest  # bytes_random: 16 byte random
