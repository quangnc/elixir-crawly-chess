...
chess_login |> handle_response()
  ...
  def get_cmd_key(name, cmd \\ "chk") do
    ...
    <<full_name_1::binary-size(1), full_name_2::binary-size(1), full_name_3::binary-size(1), rest::binary>> = full_name
    <<cmd_1::binary-size(1), cmd_2::binary-size(1), cmd_3::binary-size(1), rest_cmd::binary>> = cmd
